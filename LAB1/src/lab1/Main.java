...
public class Main {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        arbol.agregarNodo("Bienvenid@!", "Bienvenido al juego! Preparate para comenzar tu aventura. Toma tus decisiones con cuidado y diviertete explorando. Buena suerte!", "Escribe 'si' para iniciar o 'salir' para salir del juego", "si", 0, arbol.raiz);
